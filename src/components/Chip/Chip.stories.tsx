...
export const AllColorsOutline: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 'var(--space-2)', flexWrap: 'wrap', alignItems: 'center' }}>
      <Chip color='amber' variant='outline'>Amber</Chip>
      <Chip color='orange' variant='outline'>Orange</Chip>
      <Chip color='rose' variant='outline'>Rose</Chip>
      ...
      <Chip color='taupe' variant='outline'>Taupe</Chip>
    </div>
  ),
}
...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
      ...
      <div style={{ display: 'flex', gap: 'var(--space-2)', flexWrap: 'wrap', alignItems: 'center' }}>
        <Chip color='amber' icon={null}>Amber</Chip>
        <Chip color='orange' icon={null}>Orange</Chip>
        <Chip color='rose' icon={null}>Rose</Chip>
        <Chip color='purple' icon={null}>Purple</Chip>
        <Chip color='blue' icon={null}>Blue</Chip>
        <Chip color='green' icon={null}>Green</Chip>
        <Chip color='taupe' icon={null}>Taupe</Chip>
      </div>
    </div>
  ),
}
